       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="col-md-6"><!-- col-md-6 Begin -->
               ...
               <ul class="menu"><!-- cmenu Begin -->
                   ...
                   <li>
                       <a href="customer_register.php">Registrace</a>
                   </li>
                   <li>
                       <a href="checkout.php">Můj účet</a>
                   </li>
                   <li>
                       <a href="cart.php">Nákupní košík</a>
                   </li>
                   <li>
                       <a href="login.php">
       ...
       <div class="container"><!-- container Begin -->
           ...
           <div class="navbar-header"><!-- navbar-header Begin -->
               ...
               <a href="index.php" class="navbar-brand home"><!-- navbar-brand home Begin -->
                   ...
                   <img src="images/detishop-logo.png" alt="Logo" class="hidden-xs">
                   <img src="images/detishop-logo-mob.png" alt="M-dev-Store Logo Mobile" class="visible-xs">
           ...
           <div class="navbar-collapse collapse" id="navigation"><!-- navbar-collapse collapse Begin -->
               ...
               <div class="padding-nav"><!-- padding-nav Begin -->
                   ...
                   <ul class="nav navbar-nav left"><!-- nav navbar-nav left Begin -->
                       ...
                       <li class="<?php if($active=='eShop') echo"active"; ?>">
                       ...
                       <li class="<?php if($active=='Košík') echo"active"; ?>">
                           <a href="cart.php">Nákupní košík</a>
                       </li>
               ...
               <a href="cart.php" class="btn navbar-btn btn-primary right"><!-- btn navbar-btn btn-primary Begin -->
                   ...
                   <span><?php items(); ?> zboží v košíku</span>
               ...
               <div class="collapse clearfix" id="search"><!-- collapse clearfix Begin -->
                   ...
                   <form method="get" action="results.php" class="navbar-form"><!-- navbar-form Begin -->
                       ...
                       <div class="input-group"><!-- input-group Begin -->
                           ...
                           <button type="submit" name="search" value="hledat" class="btn btn-primary"><!-- btn btn-primary Begin -->
                       ...
                       <div class="box"><!-- box Begin -->
                           ...
                           <form class="form-horizontal" method="post"><!-- form-horizontal Begin -->
                               <div class="form-group"><!-- form-group Begin -->
                                   <label for="" class="col-md-5 control-label">Množství</label>
                               ...
                               <div class="form-group"><!-- form-group Begin -->
                                   <label class="col-md-5 control-label">Velikost</label>
                                   ...
                                   <div class="col-md-7"><!-- col-md-7 Begin -->
                                       ...
                                       <select name="product_size" class="form-control" required oninput="setCustomValidity('')" oninvalid="setCustomValidity('Must pick 1 size for the product')"><!-- form-control Begin -->
                                           ...
                                           <option value="" disabled selected>vybrat velikost</option>
                                           <option>S</option>
                                           <option>M</option>
                                           <option>L</option>
                               ...
                               <?php 
                                    ...
                                    if($pro_label == "sleva"){
                                        ...
                                        echo "
                                           ...
                                           Cena: <del> $pro_price Kč</del> / $pro_sale_price Kč
                               ...
                               <p class="text-center buttons"><button type="submit" name="add_cart" class="btn btn-primary"> <i class="fa fa-shopping-cart"></i>  Koupit</button></p>
                           ...
                           if(isset($_POST['add_cart'])){
                            ...
                            if(mysqli_num_rows($run_check)>0){
                                ...
                                echo "<script>alert('Zboží je již v košíku')</script>";
                                ...
                                echo "<script>alert('Vloženo do košíku')</script>";
               ...
               <div id="row same-heigh-row"><!-- #row same-heigh-row Begin -->
                   ...
                   while($row_products=mysqli_fetch_array($run_products)){
                    ...
                    if($pro_label == "sleva"){
                        ...
                        $product_price = " <del>  $pro_price Kč</del> ";
            
                        $product_sale_price = "/  $pro_sale_price Kč";
            
                    }else{
            
                        $product_price = "   $pro_price Kč ";
