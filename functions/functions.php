<?php 
$db = mysqli_connect("localhost:8889", "mamp", "", "detishopcz");
// výběr u produktu
...
function getPro(){
    ...
    while($row_products=mysqli_fetch_array($run_products)){
        ...
        if($pro_label == "sleva"){
            ...
            $product_price = " <del>  $pro_price Kč </del> Kč ";
        ...
        <div class='col-md-4 col-sm-6 single'>
            ...
            <div class='product'>
                ...
                <a href='$pro_url'>$pro_title </a></h3>
                
                    <p class='btn btn-outline-primary'> $manufacturer_title </p>
        ...
        <div class='col-md-4 col-sm-6 center-responsive'>
            ...
            <div class='product'>
                ...
                <a href='$pro_url'>
                    ...
                    <p class='btn btn-outline-primary' style='color:#9B30FF;'> $manufacturer_title </p>
