    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active"><!-- active Begin -->
                ...
                <i class="fa fa-dashboard"></i> Nástěnka / Vložit kupón
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel-heading Begin -->
               ...
               <h3 class="panel-title"><!-- panel-title Begin -->
                   ...
                   <i class="fa fa-money fa-fw"></i> Vložit
           ...
           <div class="panel-body"><!-- panel-body Begin -->
               ...
               <form method="post" class="form-horizontal"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> vybrat produkt </label> 
                      
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          
                          <select name="product_id" class="form-control" required>
                          
                            <option selected disabled>vybrat produkt pro kupón</option>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <label class="col-md-3 control-label"> Kód kupónu</label> 
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="submit" value="vytvořit" type="submit" class="btn btn-primary form-control">
...
if(isset($_POST['submit'])){
    ...
    if($check_coupons==1){
        ...
        echo "<script>alert('Kód kupónu / Produkt již byl přidán. Vyberte jiný kód kupónu / produkt')</script>";
        ...
        if($run_coupon){
            ...
            echo "<script>alert('Kupón byl vytvořen')</script>";
