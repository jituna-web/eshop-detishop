        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-pencil fa-fw"></i> Upravit kategorii
            ...
            <div class="panel-body"><!-- panel-body begin -->
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group 2 begin -->
                        ...
                        <input name="p_cat_top" type="radio" value="ano"
                        ...
                        <input name="p_cat_top" type="radio" value="ne"
                    ...
                    <div class="form-group"><!-- form-group begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input value="upravit" name="update" type="submit" class="form-control btn btn-primary">
...
if(isset($_POST['update'])){
    ...
    if(is_uploaded_file($_FILES['p_cat_image']['tmp_name'])){
      ...
      if($run_p_cat){
          ...
          echo "<script>alert('Podkategorie byla upravena')</script>";
