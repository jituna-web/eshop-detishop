...
?>
<body>
    <div id="wrapper"><!-- wrapper začátek -->

        <?php include "includes/sidebar.php"; ?>
        <div id="page-wrapper"><!-- page-wrapper začátek -->
            <div class="container-fluid"><!-- container-fluid začátek -->
            <?php
                ...
                ?>
            </div><!-- container-fluid konec -->
        </div><!-- page-wrapper konec -->
    </div><!-- wrapper konec -->
