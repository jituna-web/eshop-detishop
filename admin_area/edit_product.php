    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active"><!-- active Begin -->
                ...
                <i class="fa fa-dashboard"></i> Nástěnka/ Upravit produkty
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel-heading Begin -->
               ...
               <h3 class="panel-title"><!-- panel-title Begin -->
                   ...
                   <i class="fa fa-money fa-fw"></i> Upravit produkt
               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="product_url" type="text" class="form-control" required value="<?php echo $p_url; ?>">
                            ...
                            <p style="font-weight:bold;font-style:italic;font-size:16px;"> Použíjte '-' pro url. | Např: detska-bunda </p>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="manufacturer" class="form-control"><!-- form-control Begin -->
                              ...
                              <option disabled value="Select Manufacturer">vybrat výrobce</option>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="cat" class="form-control"><!-- form-control Begin -->
                              ...
                              <option disabled value="Select Category">vybrat kategorii</option>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <select name="product_cat" class="form-control"><!-- form-control Begin -->
                              ...
                              <option disabled value="Select Product Category">vybrat podkategorii</option>       
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                        ...
                        <select name="product_label">
                              ...
                              <option disabled> vybrat stav </option>
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="update" value="upravit" type="submit" class="btn btn-primary form-control">
