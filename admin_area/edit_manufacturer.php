    ...
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <ol class="breadcrumb"><!-- breadcrumb begin -->
            <li>
                ...
                <i class="fa fa-dashboard"></i> Nástěnka/ Výrobci
        ...
        <div class="panel panel-default"><!-- panel panel-default begin -->
            <div class="panel-heading"><!-- panel-heading begin -->
                <h3 class="panel-title"><!-- panel-title begin -->
                    ...
                    <i class="fa fa-money fa-fw"></i> Upravit výrobce
                ...
                <form action="" class="form-horizontal" method="post" enctype="multipart/form-data"><!-- form-horizontal begin -->
                    ...
                    <div class="form-group"><!-- form-group 2 begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input name="manufacturer_top" type="radio" value="ano"
                            ...
                            <input name="manufacturer_top" type="radio" value="ne"
                    ...
                    <div class="form-group"><!-- form-group 4 begin -->
                        ...
                        <div class="col-md-6"><!-- col-md-6 begin -->
                            ...
                            <input type="submit" name="update" value="upravit" class="btn btn-primary form-control">
    ...
    if(isset($_POST['update'])){
        ...
        if(is_uploaded_file($_FILES['manufacturer_image']['tmp_name'])){
            ...
            if($run_manufacturer){
                ...
                echo "<script>alert('Výrobce byl upraven')</script>";
